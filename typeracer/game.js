...
let scoreElement = document.getElementById("score"); // Score display
let timeTakenElement = document.getElementById("timeTaken"); // Time taken display
...
function calculateResults() {
    ...
    timeTakenElement.innerText = `${timeTaken.toFixed(2)} mins`;
